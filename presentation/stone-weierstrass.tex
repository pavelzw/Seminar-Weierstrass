...
\begin{frame}{Beweis von Lemma 2}
...
\begin{frame}
    ...
    Da \( \Abar \) eine Funktionenalgebra nach Lemma 3
    und somit gilt 
    \( g \in \Abar \). 
    \pause
...
\begin{frame}{Beweis vom Satz von Stone-Weierstraß}
    ...
    Nach Lemma 2 existiert ein \(H_{pq} \in \A\), 
    sodass 
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            ...
            \onslide<4->{Nach Lemma 4 gilt \( G_p \in \Abar \).}
...
\begin{frame}
    \begin{columns}
        \begin{column}{0.4\textwidth}
            ...
            \onslide<3->{Es folgt nun aus Lemma 4
